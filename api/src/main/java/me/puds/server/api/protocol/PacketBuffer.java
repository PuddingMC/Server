...
public class PacketBuffer {
    ...
    public void writePosition(Vector value, boolean legacy) {
    ...
    public void writePosition(Vector value, ProtocolVersion version) {
    ...
    public void writeIdentifier(NamespacedKey value) {
        writeString(value.toString());
    }
    ...
    public Vector readPosition(boolean legacy) {
    ...
    public Vector readPosition(ProtocolVersion version) {
        boolean legacy = !version.isNewerThan(ProtocolVersion.RELEASE_1_16);
