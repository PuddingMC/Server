...
import me.puds.server.api.protocol.packet.client.*;
...
public class ProtocolConstants {
    ...
    public static final Protocol V340 = ProtocolBuilder.builder()
            ...
            .inherit(STATUS_ONLY)
            .packet(new ClientChatMessagePacket())
            .packet(new ClientKeepAlivePacket())
            .build();

    public static final Protocol V735 = ProtocolBuilder.builder()
            .version(ProtocolVersion.RELEASE_1_16)
            .inherit(V340)
            .packet(new InteractEntityPacket())
            .packet(new PlayerPositionRotationPacket())
            .packet(new PlayerPositionPacket())
            .packet(new PlayerRotationPacket())
    ...
    public static final Protocol V1073741832 = ProtocolBuilder.builder()
            .version(ProtocolVersion.SNAPSHOT_20W49A)
            .inherit(V1073741831)
            .build();
}
